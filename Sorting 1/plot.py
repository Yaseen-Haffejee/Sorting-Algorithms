...
if __name__ == '__main__':
    ...
    filepath = pathToFolder+"/data.txt"  # TODO: add path to your data file here
    names = ['Selection Sort','Bubble Sort','Bubble Sort Escape']  # TODO: add the names of each sorting method in the order they are saved in the text file
